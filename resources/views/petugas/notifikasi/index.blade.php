...
@include('petugas.notifikasi.partials.scripts')
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-4 shadow">
                ...
                <div class="card-body">
                    @include('petugas.notifikasi.partials.table')
                </div>
            </div>
        </div>
    </div>
</div>
@include('petugas.notifikasi.modals.create')
@include('petugas.notifikasi.modals.edit')
@endsection