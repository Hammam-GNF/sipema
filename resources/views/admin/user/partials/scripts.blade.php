            ...
            "ajax": {
                ...
                "dataSrc": function(response) {
                    if (response.status === 200) {
                        return response.user.map((item, index) => {
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return '<a href="#" class="btn btn-sm btn-primary edit-btn" data-id_user="' + data.id_user + '" data-name="' + data.name + '" data-email="' + data.email + '" data-role="' + data.role + '"><i class="bi bi-pencil-fill"></i></a> ' +
                            '<a href="#" class="btn btn-sm btn-danger delete-btn" data-id_user="' + data.id_user + '"><i class="bi bi-trash"></i></a>';
                    }
                }
            ]
        });
