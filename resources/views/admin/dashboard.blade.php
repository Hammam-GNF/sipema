                    ...
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i class="fa fa-user-shield text-warning" aria-hidden="true"></i>
                            </div>
                        </div>
            ...
            <div class="card card-stats">
                <div class="card-body ">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i class="bi bi-clipboard-data text-info" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                <p class="card-category">Total Tindak Lanjut</p>
                                <p class="card-title" id="total-tindakLanjut">Loading...
                                <p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i class="bi bi-file-earmark-text text-danger" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                <p class="card-category">Total Laporan</p>
                                <p class="card-title" id="total-laporan">
                                    Loading...
                                </p>
                            </div>
                        </div>
